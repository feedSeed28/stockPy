...
/// <reference types="D:/project/stock_py/frontend/node_modules/@ant-design/pro-components" />
...
import {
  ProLayout,
} from "D:/project/stock_py/frontend/node_modules/@ant-design/pro-components";
import './Layout.css';
...
const formatMessage = undefined;
  ...
  return (
    <ProLayout
      route={route}
      location={location}
      title={userConfig.title || 'stock-quant-frontend'}
      navTheme="dark"
      siderWidth={256}
      onMenuHeaderClick={(e) => {
        e.stopPropagation();
